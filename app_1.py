...
def find_genres_movie(title_name):
    title_movie = movies[movies['title'] == title_name]
    title_genres = title_movie['genres'].tolist()[0]
    temp = movies[movies['genres'].appy(lambda x : any(genres in x for genres in title_genres))]
